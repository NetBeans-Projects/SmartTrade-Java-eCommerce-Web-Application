...
-- Dumping data for table smart_trade.user: ~5 rows (approximately)
REPLACE INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `verification`, `created_at`) VALUES
	(1, 'John', 'Carter', 'johncarter@gmail.com', 'john@123', '329071', '2025-07-15 12:30:02'),
	(2, 'Robin', 'Hood', 'robinhood@gmail.com', 'robh@234', '735323', '2025-07-15 14:36:05'),
	(3, 'Scooby', 'Doo', 'scoobydoo@gmail.com', 'scoob@587', '986474', '2025-07-15 15:00:45'),
	...
	(6, 'John', 'Carter', 'jmalshanmel@gmail.com', 'john@123', '177192', '2025-07-15 14:56:01');
