...
//        c6.createAlias("status", "st"); // make alias for join
//        c6.add(Restrictions.eq("st.value", "Active"));
...
//        responseObject.addProperty("allProductCount", productList.size());  // set max 6 , so gives 6 
