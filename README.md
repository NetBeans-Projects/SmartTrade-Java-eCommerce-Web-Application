...
| DAY 50 - 2025.07.16 (Morning) | `Update verify-account.html, Create verify-account.js, Create sign-in.html, Create sign-in.js, Create temporary index.html` | `Update SignUp.java HttpSession, Create VerifyAccount.java & SignIn.java` | `Same DB` |
| DAY 51 - 2025.07.16 (Evening) | `Same Frontend files` | `Validate with Web Filter (SessionFilter.java)` | `Same DB` |
| DAY 52 - 2025.07.17 (Morning) - Part 01 | `Update temporary index.html (Sign Out button), Create sign-out.js` | `Create SignOut.java` | `Same DB` |
