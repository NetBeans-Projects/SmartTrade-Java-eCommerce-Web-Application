...
-- Dumping data for table smart_trade.product: ~15 rows (approximately)
REPLACE INTO `product` (`id`, `title`, `model_id`, `description`, `price`, `qty`, `color_id`, `storage_id`, `quality_id`, `status_id`, `created_at`, `user_id`) VALUES
	(1, 'iPhone 15 Pro Max 256GB Sierra Blue', 2, 'The iPhone 15 Pro Max is a large high-end smartphone introduced by Apple on September 2021 as part of its iPhone 15 line, it is powered by the six-core Apple A15 processor, but with the addition of a 5th GPU core. It is splash, water, and dust resistant. It supports 5G network', 275000, 10, 4, 2, 1, 2, '2025-07-21 09:50:38', 2),
	(2, 'Galaxy S24 Ultra', 4, 'Samsung Galaxy S24 Ultra Android smartphone. Announced Jan 2024. Features 6.8″ display, Snapdragon 8 Gen 3 chipset, 5000 mAh battery, 1024 GB storage', 210000, 15, 2, 3, 2, 2, '2025-07-21 09:52:49', 1),
	(3, 'Sony Xperia 5 J9210 128GB', 5, 'Sony Xperia 5 Android smartphone. Announced Sep 2019. Features 6.1″ display, Snapdragon 855 chipset, 3140 mAh battery, 128 GB storage, 6 GB RAM', 190000, 8, 1, 1, 1, 2, '2025-07-21 09:53:59', 7),
	(4, 'iPhone 16 Pro Max 128GB Silver', 1, 'iPhone 16 Pro 128GB. Profoundly Powerful. Stunning Titanium Design — iPhone 16 Pro has a strong and light titanium design with a larger 6.3-inch Super Retina XDR display. It\'s remarkably durable with the latest-generation Ceramic Shield front that\'s 2x tougher than any smartphone glass.', 300000, 12, 2, 2, 2, 2, '2025-07-20 16:08:22', 3),
	(5, 'Apple iPhone 16 Pro - 128GB Black', 1, 'Experience cutting-edge performance with the latest A18 chip and ProMotion display.', 383680, 15, 1, 1, 1, 2, '2025-07-15 10:23:00', 1),
	(6, 'Apple iPhone 15 Pro - 256GB White', 2, 'Sleek, powerful, and built for photography lovers with an advanced triple-lens system.', 351680, 10, 2, 2, 1, 2, '2025-07-13 14:55:00', 2),
	(7, 'Samsung Galaxy S25 Ultra - 512GB Gold', 3, 'Next-gen Galaxy device with the latest Snapdragon processor and AI-powered camera.', 447680, 20, 3, 3, 1, 2, '2025-07-12 08:10:00', 1),
	(8, 'Samsung Galaxy S24 Ultra - 256GB Black', 4, 'Crystal clear AMOLED display and 200MP main camera make it perfect for content creators.', 335680, 12, 1, 2, 2, 1, '2025-07-11 19:44:00', 3),
	(9, 'Sony Xperia I VI - 128GB Red', 5, 'Cinematic 4K HDR OLED screen and professional-grade camera tuning for creators.', 319680, 8, 4, 1, 1, 2, '2025-07-10 15:35:00', 1),
	(10, 'Apple iPhone 16 Pro - 256GB Gold (Used)', 1, 'Still in great condition. Minor scratches. Battery health 89%.', 287680, 5, 3, 2, 2, 1, '2025-07-09 17:00:00', 2),
	(11, 'Galaxy S25 Ultra - 128GB White', 3, 'Brand new, with sleek design and unbeatable display quality.', 367680, 18, 2, 1, 1, 2, '2025-07-08 11:12:00', 1),
	(12, 'Xperia I VI - 512GB Gold (Used)', 5, 'Powerful phone for creatives, lightly used, includes original box.', 271680, 3, 3, 3, 2, 1, '2025-07-07 09:48:00', 2),
	(13, 'iPhone 15 Pro - 512GB Red', 2, 'Top-tier specs and camera in a stunning red finish. Perfect for professionals.', 367680, 6, 4, 3, 1, 2, '2025-07-06 12:21:00', 1),
	(14, 'Galaxy S24 Ultra - 128GB White', 4, 'Balanced performance with flagship camera and One UI 6.1.', 303680, 9, 2, 1, 1, 2, '2025-07-05 10:15:00', 3),
	(15, 'Brand New Apple iPhone 16 Pro 256GB', 1, 'Brand New Apple iPhone 16 Pro 256GB', 250000, 5, 2, 2, 1, 1, '2025-07-22 00:00:00', 1);
