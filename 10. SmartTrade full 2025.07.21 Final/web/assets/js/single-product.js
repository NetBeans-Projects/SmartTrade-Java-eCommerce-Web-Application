...
//                console.log(json);
                ...
                // similar-products
                let similar_product_main = document.getElementById("similar-product-main");
                let productHtml = document.getElementById("similar-product");
                similar_product_main.innerHTML = "";

                json.productList.forEach(item => {

//                    console.log("Loading product ID:", item.id);
//                    console.log("Image Path:", "product-images/" + item.id + "/image1.png");
                    ...
                    productCloneHtml.querySelector("#similar-product-price").innerHTML = "Rs. " + new Intl.NumberFormat(
                            ...
                            {minimumFractionDigits: 2})
                            .format(item.price);
                    productCloneHtml.querySelector("#similar-product-color-border").style.borderColor = "black";
                    productCloneHtml.querySelector("#similar-product-color-background").style.backgroundColor = item.color.value;

                    //append the clone code
                    similar_product_main.appendChild(productCloneHtml);


//                    TYPE 2 - ONE HTML MODEL EDIT WITH JQUERY
...
//                                    <img src="${'product-images\\' + item.id + '\\image1.png'}" id="similar-product-image" alt="Product Images">
//                                </a>
//                                
//                                <div class="product-hover-action">
//                                    <ul class="cart-action">
//                                        <li class="wishlist"><a href="#"><i class="far fa-heart"></i></a></li>
//                                        <li class="select-option"><a id="similar-product-add-to-cart" 
//                    ${onclick = 'addToCart(' + item.id + ', 1)'}>Add to Cart</a></li>
...
//                                <div class="inner">
//                                    <h5 class="title"><a href="${'single-product.html?id=' + item.id}" id="similar-product-title">${item.title}</a></h5>
...
//                                                <span id="similar-product-color-border" style="black">
//                                                    <span class="color" id="similar-product-color-background" style="${item.color.value}"></span>
//                                                </span> 
//                                            </li>
//                                        </ul>
//                                    </div>
